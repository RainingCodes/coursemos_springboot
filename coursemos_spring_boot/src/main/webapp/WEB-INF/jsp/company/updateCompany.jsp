...
<table class="table">    
	...
	<tr>
		...
		<td td class="form"><form:input path="companyId" placeholder="0000000000"/> <form:errors path="companyId" cssClass="error"/><br></td>
	</tr>
	<tr>
		<td class="text-center"><form:label path="place.placeName">가게명</form:label></td>
		<td td class="form"><form:input path="place.placeName" size="35" placeholder="주소 찾기 시 자동 추가됩니다"/> <form:errors path="place.placeName" cssClass="error"/><br></td>
	</tr>
	<tr>
		<td class="text-center"><form:label path="phone">전화번호</form:label></td>
		<td td class="form"><form:input path="phone"  size="35" placeholder="주소 찾기 시 값이 존재하면 자동 추가됩니다"/> <form:errors path="phone" cssClass="error"/><br></td>
	</tr>
	<tr>
		<td class="text-center"><form:label path="address">주소</form:label></td>
		<td td class="form"><form:input path="address"  size="50" placeholder="주소 찾기 시 자동 추가됩니다"/> <form:errors path="address" cssClass="error"/><br></td>
	</tr>
	<tr>
		<td class="text-center"><form:label path="place.taste">장소 분위기 선택하기</form:label></td>
		<td td class="form"><form:radiobuttons path="place.taste" items="${tasteCodes}" itemLabel="label" itemValue="code" /> <form:errors path="place.taste" cssClass="error"/></td>
	</tr>
	<tr>
